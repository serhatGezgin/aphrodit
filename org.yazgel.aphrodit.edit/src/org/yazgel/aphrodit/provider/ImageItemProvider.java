...
/**
 * This is the item provider adapter for a {@link org.yazgel.aphrodit.Image} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ImageItemProvider extends SectionElementItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Image_src_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Image_src_feature", "_UI_Image_type"),
				 AphroditPackage.Literals.IMAGE__SRC,
				 true,
				 false,
				 false,
	...
	protected void addBorderRadiusPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Image_borderRadius_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Image_borderRadius_feature", "_UI_Image_type"),
				 AphroditPackage.Literals.IMAGE__BORDER_RADIUS,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
