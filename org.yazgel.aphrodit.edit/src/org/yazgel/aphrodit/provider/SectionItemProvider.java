...
/**
 * This is the item provider adapter for a {@link org.yazgel.aphrodit.Section} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SectionItemProvider extends ElementGroupItemProvider {
	/**
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(AphroditPackage.Literals.SECTION__ELEMENTS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(AphroditPackage.Literals.SECTION__ELEMENTS,
				 AphroditFactory.eINSTANCE.createRow()));
		...
		newChildDescriptors.add
			(createChildParameter
				(AphroditPackage.Literals.SECTION__ELEMENTS,
				 AphroditFactory.eINSTANCE.createCarousel()));
		...
		newChildDescriptors.add
			(createChildParameter
				(AphroditPackage.Literals.SECTION__ELEMENTS,
				 AphroditFactory.eINSTANCE.createCard()));
		...
		newChildDescriptors.add
			(createChildParameter
				(AphroditPackage.Literals.SECTION__ELEMENTS,
				 AphroditFactory.eINSTANCE.createMap()));
	}
