...
/**
 * This is the item provider adapter for a {@link org.yazgel.aphrodit.MenuItem} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_MenuItem_title_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_MenuItem_title_feature", "_UI_MenuItem_type"),
				 AphroditPackage.Literals.MENU_ITEM__TITLE,
				 true,
				 false,
				 false,
	...
	protected void addSectionPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_MenuItem_section_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_MenuItem_section_feature", "_UI_MenuItem_type"),
				 AphroditPackage.Literals.MENU_ITEM__SECTION,
				 true,
				 false,
				 true,
				 null,
