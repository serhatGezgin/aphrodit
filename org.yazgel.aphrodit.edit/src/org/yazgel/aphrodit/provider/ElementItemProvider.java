...
/**
 * This is the item provider adapter for a {@link org.yazgel.aphrodit.Element} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 AphroditPackage.Literals.ELEMENT__NAME,
				 true,
				 false,
				 false,
	...
	protected void addColSpanPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Element_colSpan_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Element_colSpan_feature", "_UI_Element_type"),
				 AphroditPackage.Literals.ELEMENT__COL_SPAN,
				 true,
				 false,
				 false,
	...
	protected void addColorPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Element_color_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Element_color_feature", "_UI_Element_type"),
				 AphroditPackage.Literals.ELEMENT__COLOR,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addBackgroundColorPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Element_backgroundColor_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Element_backgroundColor_feature", "_UI_Element_type"),
				 AphroditPackage.Literals.ELEMENT__BACKGROUND_COLOR,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addBackgroundImagePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Element_backgroundImage_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Element_backgroundImage_feature", "_UI_Element_type"),
				 AphroditPackage.Literals.ELEMENT__BACKGROUND_IMAGE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
