...
/**
 * This is the item provider adapter for a {@link org.yazgel.aphrodit.Card} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CardItemProvider extends SectionElementItemProvider {
	/**
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(AphroditPackage.Literals.CARD__PAGES);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Card.class)) {
			case AphroditPackage.CARD__PAGES:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(AphroditPackage.Literals.CARD__PAGES,
				 AphroditFactory.eINSTANCE.createCardPage()));
	}
