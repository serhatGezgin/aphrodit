...
/**
 * This is the item provider adapter for a {@link org.yazgel.aphrodit.Header} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class HeaderItemProvider extends SectionElementItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 AphroditPackage.Literals.HEADER__TYPE,
				 true,
				 false,
				 false,
	...
	protected void addContentPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Header_content_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Header_content_feature", "_UI_Header_type"),
				 AphroditPackage.Literals.HEADER__CONTENT,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
